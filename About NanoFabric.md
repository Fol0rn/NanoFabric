# NanoFabric
**NanoFabric** is for performance only modpack for your **PC** to feel smoother and faster on Minecrafts unoptimized game. Every config and setting was set for low end users, but still helping for medium/high end users.

This is an inspiration from **Simply Optimized**, but because I didn't have knowledge in the time, I decided to learn while still making **NanoFabric**. Meaning there will be no QoL mods in NanoFabric, no other mods that might bloat Minecraft or make it like the hundreds of "performance" modpacks. And also not try to use the legacy of Simply Optimized for free money.
